...
void mousePressed() {
  ...
  if (userChoice == "Rock" && randomInt == (int) random(3)) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Paper" && randomInt == (int) random(3))
    text("You Lost!", 500, 500);
  else if (userChoice == "Scissors" && randomInt == (int) random(3));
  text("You tied!!", 500, 500);

  if (userChoice == "Scissors" && randomInt == (int) random(2)) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Rock" && randomInt == (int) random(2))
    text("You Lost!", 500, 500);
  else if (userChoice == "Paper" && randomInt == (int) random(2));
  text("You tied!!", 500, 500);


  if (userChoice == "Paper" && randomInt == (int) random(1)) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Scissors" && randomInt == (int) random(1))
    text("You Lost!", 500, 500);
  else if (userChoice == "Rock" && randomInt == (int) random(1));
  text("You tied!!", 500, 500);
}
