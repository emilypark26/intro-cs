...
void draw() {
  ...
  if (userChoice == "Rock" && randomInt == 2) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Paper" && randomInt == 2) {
    text("You Lost!", 500, 500);
  } else if (userChoice == "Scissors" && randomInt == 2) {
    text("You tied!!", 500, 500);
  } else if (userChoice == "Scissors" && randomInt == 1) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Rock" && randomInt == 1) {
    text("You Lost!", 500, 500);
  } else if (userChoice == "Paper" && randomInt == 1) {
    text("You tied!!", 500, 500);
  } else if (userChoice == "Paper" && randomInt == 0) {
    text("You Won!!", 500, 500);
  } else if (userChoice == "Scissors" && randomInt == 0) {
    text("You Lost!", 500, 500);
  } else if (userChoice == "Rock" && randomInt == 0) {
  text("You tied!!", 500, 500);
  }
}
